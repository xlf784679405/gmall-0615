...
public class OSSController {
    ...
    public Resp<Object> policy(){
        ...
        String accessId = "LTAI4FoYmQdRFL4KmEByMKmm"; // 请填写您的AccessKeyId。
        String accessKey = "IZxCbvDi4dzC32bS4NvrTysDbNKaXE"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "scw-xlf-0615"; // 请填写您的 bucketname 。
