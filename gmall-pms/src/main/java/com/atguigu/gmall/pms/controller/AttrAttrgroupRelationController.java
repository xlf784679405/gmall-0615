...
public class AttrAttrgroupRelationController {
    ...
    public Resp<Object> deleteByGidAndAttrId(@RequestBody List<AttrAttrgroupRelationEntity> relationEntity){

        this.attrAttrgroupRelationService.remove(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_group_id" , relationEntity.get(0).getAttrGroupId()).eq("attr_id" , relationEntity.get(0).getAttrId()));
        return Resp.ok("删除成功");
    }
